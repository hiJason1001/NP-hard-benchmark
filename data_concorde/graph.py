...
NAMES = ["concorde_tsphcp"]
FOLDER = "data_concorde"
TIME_UNIT = "seconds"
...
FONT = 24
OUTPUT_FILE = f"data_concorde/combined_plot.png"
# ========================
...
for idx, NAME in enumerate(NAMES):
    ...
    while i < len(lines):
        ...
        if line.endswith(".hcp") or line.endswith(".tsp"):
            ...
            is_tle = "time limit exceeded" in time_line or "no" in result_line
            total_time = None
...
if not all_records:
    ...
    tle_plotted = False  # Ensure TLE is only labeled once
